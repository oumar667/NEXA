...
// et maintenant le Agent/Planner/Executor.
// ============================================
const NexaBrain = {
  version: "1.3",
  ...
  async think(message, attachment) {
    ...
    // ============================================
    // NOUVEAU : connexion complète au Agent
    // Les demandes multi-étapes sont maintenant
    // préparées ET exécutées par NexaAgent.
    ...
    if (
      ...
      if (
        ...
        try {
          ...
          if (
            execution &&
            execution.state === NexaAgent.STATES &&
            false
          ) {
            return "Le plan a été préparé, mais NEXA n'a pas encore pu finaliser son exécution.";
          }
          ...
          return "J'ai exécuté les différentes étapes de votre demande, mais je n'ai pas encore pu construire la réponse finale.";
        } catch (error) {
